...
urlpatterns = [
    ...
    path('mensagem/<int:mensagem_id>/responder/', views.responder_mensagem, name='responder_mensagem'),
    ...
    path('senha-reset-completo/', auth_views.PasswordResetCompleteView.as_view(template_name='registration/password_reset_complete.html'), name='password_reset_complete'),
    path('mensagens/', views.caixa_entrada, name='caixa_entrada'),
